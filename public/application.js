...
var createBarber = function createBarber(data) {
...
var getBarber = function getBarber(data) {
...
var getAllBarbers = function getAllBarbers(data) {
...
var createAppt = function createAppt(data) {
...
var viewBarbersAppt = function viewBarbersAppt(data) {
  // console.log('Appointment information is: ', data)
  return $.ajax({
    url: config.apiUrl + '/appointments',
    method: 'GET',
...
var viewClientAppt = function viewClientAppt(data) {
  // console.log('Appointment information is: ', data)
  return $.ajax({
    url: config.apiUrl + '/appointments',
    method: 'GET',
...
var editAppt = function editAppt(data) {
  // console.log('Appointment information is: ', data)
  return $.ajax({
...
var deleteAppt = function deleteAppt(data) {
  console.log(data);
  return $.ajax({
...
module.exports = {
  ...
  viewBarbersAppt: viewBarbersAppt,
  editAppt: editAppt,
  deleteAppt: deleteAppt,
  viewClientAppt: viewClientAppt
};
...
$(document).ready(function () {
  ...
  var appt = document.getElementsByClassName('.barber-appts');
...
var createBarber = function createBarber(event) {
  event.preventDefault();
  console.log('Barber being created...');

  var data = getFormFields(this);
  api.createBarber(data).then(ui.createBarberSuccess).catch(ui.createBarberFail);
};

var getBarber = function getBarber(event) {
  event.preventDefault();
...
var getAllBarbers = function getAllBarbers(event) {
  event.preventDefault();
  // console.log("getting all barbers")

  var data = getFormFields(this);
  api.getAllBarbers(data).then(ui.getAllBarbersSuccess).catch(ui.getAllBarbersFailure);
};

var newAppt = function newAppt(event) {
  event.preventDefault();
  ...
  var data = getFormFields(this);
  // console.log(data)
  api.createAppt(data).then(ui.appointmentCreated).catch(ui.appointmentFailed);
};

var viewAppt = function viewAppt(event) {
  event.preventDefault();

  var data = getFormFields(this);
  // console.log(data)
  api.viewBarbersAppt(data).then(ui.viewApptSuccess).catch(ui.viewApptFail);
};

var editAppt = function editAppt(event) {
  event.preventDefault();

  var data = getFormFields(this);
  // console.log(data)
  api.editAppt(data).then(ui.editApptSucces).catch(ui.editApptFail);
};

var clientViewAppt = function clientViewAppt(event) {
  event.preventDefault();

  var data = getFormFields(this);
  // console.log(data)
  api.viewClientAppt(data).then(ui.viewclientApptSuccess).catch(ui.viewApptFail);
};
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://kelechibarbershop.herokuapp.com',
...
var signInSuccess = function signInSuccess(data) {
  ...
  if (data.credentials) alert('Welcome ' + data.user.email + " !");
...
var createBarberSuccess = function createBarberSuccess(data) {
...
var createBarberFail = function createBarberFail(error) {
  //console.log("failed to create a new barber")
};

var getBarberSuccess = function getBarberSuccess(data) {
...
var getBarberFail = function getBarberFail(error) {
  // console.log("failed to get barber")
};

var getAllBarbersSuccess = function getAllBarbersSuccess(data) {
  // console.log("successfully showing all barbers: " + JSON.stringify(data.barbers))

  var person = data.barbers;
  var list = $('.dropdown-content');

  var listBarbers = function listBarbers(data) {
...
var getAllBarbersFail = function getAllBarbersFail(error) {
  // console.log("failed to create a new barber")
};

var appointmentCreated = function appointmentCreated(data) {
...
var appointmentFailure = function appointmentFailure(error) {
...
var viewApptSuccess = function viewApptSuccess(data) {
  ...
  var listBarbers = function listBarbers(data) {
    var _loop2 = function _loop2(i) {
      ...
      var style = data[i].haircut;
      var barber_id = data[i].barber_id;
      var appt_id = data[i].id;

      if (barber_id == myBarber) {
        list.append('<li class="barber-appts" id="appt-' + appt_id + '" value="' + appt_id + '">' + JSON.stringify(appt_id) + ' ' + JSON.stringify(name) + ' ' + JSON.stringify(style) + ' ' + JSON.stringify(date) + ' ' + JSON.stringify(time) + ' ' + '<button id="edit">Edit</button><button class"delete "id="' + appt_id + '">Delete</button></li>');
        ...
        $('.delete').on('click', function (event) {
          ...
          // onDeleteAppt(event)
          // const data = getFormFields(this)
          api.deleteAppt(appt_id).then(deleteSuccess).catch(deleteFail);
...
var viewclientApptSuccess = function viewclientApptSuccess(data) {
  // console.log("successfully showing all your appts: " + JSON.stringify(data.appointments))

  var appt = data.appointments;
  var list = $('.cl-appt-list');
  ...
  var listBarbers = function listBarbers(data) {
    var _loop3 = function _loop3(i) {
      ...
      var barber_id = appt.barber_id;
      var myID = store.user.id;

      if (user_id == myID) {
        list.append('<li class="cl-appts" value=' + appt_id + '>' + JSON.stringify(style) + ' ' + JSON.stringify(date) + ' ' + JSON.stringify(time) + ' ' + '<button id="cli-edit">Edit</button><button class="delete" id="' + appt_id + '">Delete</button></li>');
...
var viewApptFail = function viewApptFail(error) {
  // console.log("failed to view appointment")
};

var editApptSucces = function editApptSucces(data) {
...
var editApptFail = function editApptFail(error) {
...
var deleteFail = function deleteFail(error) {
...
module.exports = {
  ...
  createBarberFail: createBarberFail,
  createBarberSuccess: createBarberSuccess,
  getBarberSuccess: getBarberSuccess,
  getBarberFail: getBarberFail,
  getAllBarbersFail: getAllBarbersFail,
  getAllBarbersSuccess: getAllBarbersSuccess,
  appointmentCreated: appointmentCreated,
  appointmentFailure: appointmentFailure,
  viewApptSuccess: viewApptSuccess,
  viewApptFail: viewApptFail,
  editApptSucces: editApptSucces,
  editApptFail: editApptFail,
  deleteSuccess: deleteSuccess,
  deleteFail: deleteFail,
  viewclientApptSuccess: viewclientApptSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
